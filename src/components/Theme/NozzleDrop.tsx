...
import { NozzleProps } from '../../types/Nozzle.types'

const NozzleDrop:React.FC<NozzleProps> = ({full,setValue,value,title="No"}) =>{
  return (
   <div className={`${full? "w-full ":"w-[200px]"}`}>
      <label className=' text-slate-200  '>No.{title}</label>
